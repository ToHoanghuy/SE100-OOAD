    ...
    <body class="bg-blue-100 flex items-center justify-center min-h-screen">
      <div class="bg-white rounded-lg shadow-lg flex max-w-4xl w-full">
        <div class="bg-blue-200 p-10 rounded-l-lg flex flex-col items-center justify-center w-1/2">
          ...
          <p class="text-lg mb-8">Bạn muốn đăng ký kinh doanh?</p>
          <img
            alt="Illustration of a person promoting a product on social media"
            class="w-64 h-64"
            height="300"
            src={require("../assets/images/registry1.png")}
            width="300"
          />
        </div>
        ...
        <div class="p-10 w-1/2">
          ...
          <p class="mb-6 text-gray-500">Vui lòng nhập thông tin đăng ký</p>
          <form>
            <div class="">
